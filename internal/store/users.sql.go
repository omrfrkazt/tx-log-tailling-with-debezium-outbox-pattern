...
$1,$2,$3,$4
) RETURNING id, aggregatetype, aggregateid, type, payload
`
...
func (q *Queries) AddOutbox(ctx context.Context, arg AddOutboxParams) (OutboxEvent, error) {
	row := q.db.QueryRowContext(ctx, addOutbox,
		arg.Aggregatetype,
		arg.Aggregateid,
		arg.Type,
		arg.Payload,
